...
/* Define to 1 if you have c++-gtk-utils-1.2. */
/* #undef HAVE_CXX_GTK_UTILS_12 */

/* Define to 1 if you have c++-gtk-utils-2.0. */
/* #undef HAVE_CXX_GTK_UTILS_20 */

/* Define to 1 if you have c++-gtk-utils-2.2. */
#define HAVE_CXX_GTK_UTILS_22 1
...
#define PACKAGE_STRING "efax-gtk 3.2.13"
